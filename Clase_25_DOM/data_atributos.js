...
let primerParrafo = document.getElementsByTagName("p")[0];//seleccono el primer elemento del htmlCollection
...
// let primerParrafo = document.getElementsByTagName("p")[0];
 enlaces = primerParrafo.getElementsByTagName("a");//selecciono los enlaces en un HTMLCollection
...
let hijos = milista.children;//htmlCollection con todos los hijos de milista
...
let parrafos2 = document.querySelectorAll("div.hero p");
...
let ultimoElemento2 = document.body.lastElementChild;
ultimoElemento2.remove();
...
let primerP2 = document.getElementsByTagName("p")[0];
// primerP.setAttribute("class", "claseejemplo");
primerP2.classList.add("claseejemplo");
