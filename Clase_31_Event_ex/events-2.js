...
// let pEliminar = document.getElementById('pParaEliminar');

// for (let b of buttons){
//     b.addEventListener('click', (event) => {
//         let letter = event.target.dataset.letter;
//         //console.log(letter);
//         let actualText = pEliminar.textContent;
//         actualText = actualText.replaceAll(letter,'');
//         //console.log(actualText);
//         pEliminar.textContent = actualText;
...
//                 document.getElementById('results').textContent = "Ha ganado el verde";
                
//                 //console.log(width);
//             } else {
//                 document.getElementById('results').textContent = "Ha ganado el rojo";
//             }
//             document.body.removeEventListener('keydown',presionarTecla)//solo funciona con funciones con nombre, no anonimas
//         }
//     }
// }
